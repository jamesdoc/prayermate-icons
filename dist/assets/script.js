(() => {
  ...
  var backgroundPickers = document.querySelectorAll(".js-backgroundPicker");
  var backgroundPickerHex = document.querySelector(".js-backgroundPickerHex");
  var iconPickerHex = document.querySelector(".js-iconPickerHex");
  var colorPickers = document.querySelectorAll(".js-colorPicker");
  var iconPickers = document.querySelectorAll(".js-icon");
  var preview = document.querySelector(".preview");
  var btnSave = document.querySelector(".js-save");
  var txtSearch = document.querySelector(".js-iconSearch");
  var counter = 0;
  var iconDetails = {
  ...
  btnSave.addEventListener("click", function(e) {
    e.preventDefault();
    import_dom_to_image.default.toPng(preview).then(function(dataUrl) {
  ...
  function setIcon() {
    const selectedIcon = document.getElementById(iconDetails.icon).outerHTML.replaceAll("symbol", "svg");
